...
impl PropertyAccess for Gaussian {
    ...
    fn set_property(&mut self, property_name: String, property: Property)
    {
        ...
        match (property_name.as_ref(), property) {
            ...
            ("rot_0", Property::Float(v)) => self.rotation[3] = v,
            ("rot_1", Property::Float(v)) => self.rotation[0] = v,
            ("rot_2", Property::Float(v)) => self.rotation[1] = v,
            ("rot_3", Property::Float(v)) => self.rotation[2] = v,
